...
def main_gui():
    ...
    group4.add_argument("--fi", dest="filter_include_list", action="store", type=str, nargs="+", default=None, metavar="regex",
                        help="Filter: Only include files matching the regular expression(s) (include all by default, searches file paths)")
    group4.add_argument("--fe", dest="filter_exclude_list", action="store", type=str, nargs="+", default=None, metavar="regex",
                        help="Filter: Exclude files matching the regular expression(s) (exclude has priority over include, searches file paths)")
    group4.add_argument("--forbidden-exts", dest="forbidden_extensions_list", action="store", type=str, nargs="+", default=None, metavar="token",
                        help="Forbidden extensions list")
